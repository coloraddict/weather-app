...
export class WeatherForecastService {
  ...
  getWeather(city){
    // console.log(city);
    return this.http.get("http://api.openweathermap.org/data/2.5/weather?q=" + city + "&appid=a50a790c1717bcbc09c88e191997fe3f");
  }

  getForecast(p_lat, p_lon){
    return this.http.get("https://api.openweathermap.org/data/2.5/forecast?lat=" + p_lat + "&lon=" + p_lon + "&appid=a50a790c1717bcbc09c88e191997fe3f");
  }
}
